        ...
        <div className="w-full max-w-md mx-auto p-6 bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/10 flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <button
                    ...
                    className="w-full px-6 py-4 bg-primary text-white font-bold text-lg rounded-xl hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50"
                >
                    {loading ? (
